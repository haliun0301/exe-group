      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid justify-center about-text text-gray-500 px-4">
          ...
          <div className="items-center divide-black grid grid-cols-3 justify-center divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium m-3">{t.aboutPage.row0_1}</div>
          ...
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium m-3">{t.aboutPage.row1_1}</div>
            <div className="col-span-2 p-4">{t.aboutPage.row1_2}</div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium md:m-6">{t.aboutPage.row2_1}</div>
            <div className="col-span-2 p-4">{t.aboutPage.row2_2}</div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row3_1}</div>
            <div className="col-span-2 p-4">
          ...
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row4_1}</div>
            <div className="col-span-2 p-4">{t.aboutPage.row4_2}</div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row5_1}</div>
            <div className="col-span-2 p-4">
              {t.aboutPage.row5_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row6_1}</div>
            <div className="col-span-2 p-4">
              {t.aboutPage.row6_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-b-2 border-t-black border-r-black border-l-black border-b-black">
            <div className="text-center font-medium">{t.aboutPage.row7_1}</div>
            <div className="col-span-2 p-4">
              {t.aboutPage.row7_21}
              <br></br>
              {t.aboutPage.row7_22}
              ...
              {t.aboutPage.row7_23}
              <br></br>
              {t.aboutPage.row7_24}<br></br>
              {t.aboutPage.row7_25}<br></br>
              {t.aboutPage.row7_26}<br></br>
            </div>
          </div>
        </div>
        {/* table2 */}
        <div className="grid justify-center mt-10 mb-10 about-text px-4 text-gray-500">
          ...
          <div className="items-center divide-black grid grid-cols-3 justify-center divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row8_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row8_2}{" "}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row9_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row9_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row10_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row10_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row11_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row11_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row12_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row12_2}
            </div>
          </div>
          <div className="items-center divide-black grid grid-cols-3 divide-x border-t-2 border-r-2 border-l-2 border-t-black border-b-2 border-b-black border-r-black border-l-black">
            <div className="text-center font-medium">{t.aboutPage.row13_1}</div>
            <div className="col-span-2 p-4">
            {t.aboutPage.row13_2}
            </div>
          </div>
