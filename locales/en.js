export default {
    ...
    slider2: "excellent investment opportunities",
    myanmar: "Myanmar",
    mongolia: "Mongolia",
    recruit: "Recruit",
    ...
    myanmarPage: {
        ...
        line21: "Business center",
        line21_1: "(internet access available from each room, contract required)",
    ...
    internshipPage: {
        ...
        table3_title: "Sakura Residence Training Program (Example)",
        table3_row0_1: "Days",
        table3_row0_2: "Content",
        table3_row1_21: "Arrival in Yangon,",
        table3_row1_22: "Introduction to Sakura Residence,",
        table3_row1_23: "Housekeeping Training (Public Areas)",
        table3_row2_2: "Housekeeping Training (Public Areas, Pest Control)",
        table3_row3_2: "Day off",
        table3_row4_2: "Housekeeping Training (Room Cleaning)",
        table3_row5_2: "Housekeeping Training",
        table3_row6_2: "Housekeeping Training",
        table3_row7_2: "Day off",
        table3_row8_2: "Reception Training (Bell Staff) ",
        table3_row9_2: "Reception Training (Gym)",
        table3_row10_2: "Day off",
        table3_row11_2: "Reception Training (Front Desk) ",
        table3_row12_2: "Reception Training",
        table3_row13_2: "Day off",
        table3_row14_2: "Reception Training",
        table3_row15_1: "Housekeeping Training",
        table3_row15_2: "You will learn the basics of working in a food and beverage establishment, including dishwashing, cleaning, and essential skills for a barista, such as using specialized coffee machines and preparing fresh juice. ",
        table3_row16_1: "Reception Training",
        table3_row16_2: "You will also practice providing customer service in English and learn how to create cocktails and desserts. During the reception training, you will handle inventory and cleaning tasks, set up tables and the bar area, and learn how to provide customer service in English.",
        text6: "Sakura Tower, a landmark in Yangon, houses prominent global companies and organizations such as JICA, Mitsubishi Corporation, Nikkei, and NHK. It attracts expatriates and tourists from Europe, Asia, and other overseas locations.",
        text_frame: "At Sakura Residence, approximately 30% of residents are Japanese, and 70% are expatriates from Europe and Asia. English customer service is a daily occurrence.",
        ...
        text15: "After working in overseas financing approval for a Japanese bank, Toshihide joined Excel and has been stationed as the Myanmar Director since 2011. While previously dealing with European and American work, Myanmar's vibrancy and dedication to the nation and city's development are highly motivating. Interacting with corporate expatriates and young entrepreneurs worldwide, he finds it a lively and reliable environment. Courage, enthusiasm, and a willingness to immerse oneself in various circles are vital qualities for success. He encourages others to take on this challenge.",
        title5: "Frequently Asked Questions (FAQ):",
        question1: "What is Myanmar like as a country? ",
        answer1: 'Myanmar, known as "Asia Last Frontier," is a multicultural nation with a population of 53.8 million and 135 ethnic groups. It was a former British colony and uses Burmese and English as official languages. Approximately 90% of the population practices Buddhism, and pagodas adorn the cityscape. The people are known for their simplicity, gentleness, and similarities to the Japanese temperament.',
        question2: "How frequently is English used? ",
        answer2: "English is used for communication with overseas expatriates and local staff. Interaction with local staff may involve speaking Burmese as well.",
        question3: "Are there any language requirements such as TOEIC? ",
        answer3: "For short-term internships (within three months), having an English proficiency of around TOEIC 800 points can provide broader opportunities for various tasks. For longer internships (e.g., six months), initial English proficiency is not mandatory, but having around TOEIC 600 points is desirable.",
        question4: "Is there any concern about safety and hygiene? ",
        answer4: "Since 2021, there have been security concerns due to the military regime. However, following the rules for expatriates' activities ensures a trouble-free experience. In over 40 internship placements, no troubles or accidents have occurred. For hygiene, caution is necessary when dining outside, so following the guidance of expatriates is essential.",
    },
    recruitPage: {
        head_title1: "Recruitment Information",
        head_title2: "Change is an opportunity.",
        head_title3: "Believe in your own values, not just what others think.",
        text1: 'Our constant belief has been, "Change is an opportunity." Embracing the change as a business chance without faltering in the face of changing times is the spirit of our company. ',
        text2: "Beliefs about investments also lead to beliefs about people.",
        text3: "Retrieving data. Wait a few seconds and try to cut or copy again.",
        table_title: "Job Offer Details",
        row1_1: "Recruitment Position",
        row1_2: "General",
        row2_1: "Detailed Responsibilities",
        row2_21: "Project management work",
        row2_22: "You will be in charge of all operations related to office buildings, serviced apartments, hotels and restaurants owned in Myanmar.",
        row2_23: "Sales, engineering, accounting, human resources and general affairs, etc.",
        row2_24: "Sakura Tower",
        row2_25: "Yangon landmark tower",
        row2_26: "Many Japanese companies have offices, and the rooftop bar “Yangon Yangon” located on the top floor has become the center of entertainment in Myanmar.",
        row2_27: "Sakura Residence",
        row2_28: "Yangon's largest apartment for long-term stays",
        row3_1: "Employment Type",
        row3_2: "Full-Time",
        row4_1: "Recruitment/Selection Process: ",
        row4_21: "Document Screening, Interview Examination, English Test, and Final Assessment through a one-week internship training in Yangon.",
        row5_1: "Selection Criteria",
        row5_21: "Individuals interested in Asia and those who love Asia. ",
        row5_22: "Candidates with courage and charisma, and those interested in learning Myanmar language are welcome.",
        row6_1: "Required Documents",
        row6_2: "Resume (Career history sheet for mid-career applicants)",
        row7_1: "Estimated Annual Income",
        row7_2: "Annual income: 2.8 to 5 million JPY (Details will be provided during the initial interview)",
        row8_1: "Promotions, Bonuses, and Allowances: ",
        row8_2: "Promotions are available, and bonuses are provided.",
        row9_1: "Work Location",
        row9_2: "Myanmar (Yangon) ",
        row10_1: "Working Hours",
        row10_2: "Sakura Tower: 8:30 AM to 5:30 PM Hotel, Residence, Restaurant, Bar: 5:30 AM to 11:00 PM (Shift-based)",
        row11_1: "Employee Benefits",
        row11_2: "Yearly rewards based on service years, company housing, transportation services, meal allowance",
        row12_1: "Social Insurance",
        row12_2: "Covered",
        row13_1: "Holidays",
        row13_21: "4 to 8 days per month (including shifts)",
        row13_22: "Subject to change depending on assigned tasks and event periods, following the Myanmar calendar",
        row14_1: "Education and Training",
        row14_2: "Support system available as needed",
        title1: "Recruiter's Message",
        text4: 'As a Japanese HR representative, I handle internships, new graduate, and mid-career recruitment. After graduating from university, I worked for a multinational major human resources company for ten years and am currently in charge of HR at EXE Corporation. "Change is an opportunity" has been our belief since the companys founding. I wholeheartedly support those who strive to establish their own values and carve out their future. If you are interested, please feel free to contact us!',
        title2: "Frequently Asked Questions:",
        question1: "What is Myanmar like as a country? ",
        answer1: "Myanmar, known as < Asia's Last Frontier, > is a multicultural nation with a population of 53.8 million and 135 ethnic groups. It was a former British colony and uses Burmese and English as official languages. Approximately 90% of the population practices Buddhism, and pagodas adorn the cityscape. The people are known for their simplicity, gentleness, and similarities to the Japanese temperament.",
        question2: "How frequently is English used? ",
        answer2: "English is used for communication with overseas expatriates and local staff. Interaction with local staff may involve speaking Burmese as well.",
        question3: "Are there any language requirements such as TOEIC? ",
        answer3: "For short-term internships (within three months), having an English proficiency of around TOEIC 800 points can provide broader opportunities for various tasks. For longer internships (e.g., six months), initial English proficiency is not mandatory, but having around TOEIC 600 points is desirable.",
        ...
        answer5: "You will be stationed at Sakura Residence, owned by Excel Co., Ltd. Japanese expatriates are also stationed here, providing a support system for any difficulties you may encounter.",
        question6: "Is participating in the internship mandatory?",
        answer6: 'Unlike a regular trip, living in Myanmar requires an understanding of local customs, culture, and habits. While participating in the internship is not mandatory, we recommend doing so before considering regular employment.',
        
    },
    footer: {
        contactUs: "Contact Us",
        address: "6F Sawada Kojimachi Building, 1-10-5 Kojimachi, Chiyoda-ku, Tokyo 102-0083",
